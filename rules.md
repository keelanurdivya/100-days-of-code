...
## Main Commitment
### *I will code for ATLEAST 3 HOURS every day for the next 100 days.*

#### Start Date
December 1st, 2020. [PUT YOUR DATE HERE]
...
5. I will work on real projects, facing real challenges. The time spent doing tutorials, online courses and other similar resources will still count towards this challenge as im still in learning process. (If you've just started learning to code, read [FAQ](FAQ.md))
